...
class SuperHexagonGymEnv(gym.Env):
    ...
    def _get_state(self):
        ...
        # Zustandsvektor: Basiswert, Wandinfo, Player-Angle, Direction
    ...
    def get_direction(self):
        ...
        if left_distance < right_distance:
            return 0.0  # Öffnung links näher
        else:
            return 1.0  # Öffnung rechts näher
    ...
    def learn(self):
        ...
        while current_step < self.total_timesteps:
            ...
            if current_step % 10000 < self.n_steps:
                ...
                print(
                    f"Step: {current_step}, Avg. Episode Length: {avg_episode_length:.2f}, Episoden Reward: {ep_rewards:.2f}"
                )
                ep_rewards = 0
                episode_lengths = []
